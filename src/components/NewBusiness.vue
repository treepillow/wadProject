...
export default {
  ...
  methods: {
      ...
      // menu functions
      // on click, add new inputs for item 
      addMenuItem() {
        // creates a new menu item object and updates according to user input in fields
        this.menuItems.push({ name: '', price: '' }) 
      },
      // remove menu item on click '-'
      removeMenuItem(i) {
          // prevent deleting last item -> Ensure that the menu at least has 1 menu item for users to fill up
          if (this.menuItems.length === 1) 
          return this.menuItems.splice(i, 1)
      },

      // photo upload + database
      ...
      async handleSubmit(e) {
          ...
          // ensure that item name and price is filled (no empty fields)
          for (let i = 0; i < this.menuItems.length; i++) {
            const menuItem = this.menuItems[i];
            
            // Check if name or price is empty
            if (!menuItem.name.trim() || !menuItem.price.trim()) {
              alert(`Please ensure that item name and price are filled.`);
              return
            }
          }
          ...
          try {
              ...
              // collection (database) to store all listings -> to display all listings for consumers
              ...
              // store in subcollection of users -> to display users own listings
  ...
  <div class="listing-card shadow-sm rounded-4 p-4 p-md-5">
      <form @submit="handleSubmit">
          <div class="row g-4">
              ...
              <div class="col-lg-6">
                  <!-- Upload zone -->
                  <div class="upload-zone rounded-4 border-dashed mb-3 d-flex flex-column align-items-center justify-content-center"
                      :class="{'dragging': isDragging}" @drop="onDrop" @dragover="onDragOver"
                      @dragleave="onDragLeave" @click="openFilePicker" role="button" tabindex="0">
                  ...
                  <div class="mb-3">
                      ...
                      <input type="text" class="form-control" v-model="businessLocation"
              ...
              <div class="col-lg-6">
                  ...
                  <div class="mb-3">
                      <div class="d-flex align-items-center justify-content-between mb-2">
                          ...
                          <!-- new input fields for menu items -->
          ...
          <div class="mt-4 d-flex justify-content-center gap-3">
              ...
              <button type="button" class="btn btn-outline-secondary px-4 py-2" @click="clearForm">Clear
                  Form</button>
          </div>
      </form>
  </div>
